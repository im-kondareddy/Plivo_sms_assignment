...
class SmsAccount():
  main_auth_id = 'xxxxxxxxxxxxxxxxxxxx'
  main_auth_token = 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx'
  sub_auth_id = 'xxxxxxxxxxxxxxxxxxxx'
  sub_auth_token = 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx'
